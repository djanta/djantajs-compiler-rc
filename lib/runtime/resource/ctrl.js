...
module.exports = class Controller extends Serializable {
  ...
  get serialize() {
    ...
    return fill(self, _.defaults({}), [
      'name', 'root', 'enabled', 'model', 'description', {
        name: 'hook', render: (o, nm) => _.reduce(_.isArrayLikeObject(o[nm]) ?
      ...
      {
        name: '_verbs', alias: 'endpoints', render: (o, name) =>
        _.reduce(o[name], (result, verb) => {
