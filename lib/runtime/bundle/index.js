...
let { annotations, fill, defaults } = require('../../utils');
...
module.exports = class Bundle extends Serializable {
   ...
   */
  static get targets() {
    return annotations.bundle.index.target;
  }
  ...
  static get annotation() {
    return annotations.bundle.index.type;
  }
  ...
  get annotationName() {
    return annotations.bundle.index.name;
  }
